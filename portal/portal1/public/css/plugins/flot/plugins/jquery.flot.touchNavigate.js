...
(function($) {
        ...
        pinch = {
            ...
            drag: function(e) {
                ...
                pinchDragTimeout = setTimeout(function() {
                    ...
                    var <?= BASEURL; ?>/css/dist = pinchDistance(e);

                    if (gestureState.zoomEnable || Math.abs(<?= BASEURL; ?>/css/dist - gestureState.prevDistance) > ZOOM_DISTANCE_MARGIN) {
    ...
    function zoomPlot(plot, e, gestureState, navigationState) {
        var offset = plot.offset(),
            ...
            <?= BASEURL; ?>/css/dist = pinchDistance(e);
        ...
        gestureState.prevDistance = <?= BASEURL; ?>/css/dist;
    }
