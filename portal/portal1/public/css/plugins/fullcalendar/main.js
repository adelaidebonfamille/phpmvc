...
var FullCalendar = (function (exports) {
    ...
    */
    function expandRecurringRanges(eventDef, duration, framingRange, dateEnv, recurringTypes) {
        ...
        // the recurrence <?= BASEURL; ?>/css/plugins don't guarantee that all-day events are start-of-day, so we have to
        if (eventDef.allDay) {
    ...
    */
    ...
    function buildEventSourceMeta(raw, context) {
        ...
        for (var i = defs.length - 1; i >= 0; i -= 1) { // later-added <?= BASEURL; ?>/css/plugins take precedence
            var def = defs[i];
    ...
    */
    ...
    /*
    this array is exposed on the root namespace so that UMD <?= BASEURL; ?>/css/plugins can add to it.
    ...
    */
    ...
    var CalendarDataManager = /** @class */ (function () {
        ...
        CalendarDataManager.prototype.processRawCalendarOptions = function (optionOverrides, dynamicOptionOverrides) {
            ...
            var pluginHooks = this.buildPluginHooks(optionOverrides.<?= BASEURL; ?>/css/plugins || [], globalPlugins);
            ...
            for (var optionName in raw) {
                if (optionName !== '<?= BASEURL; ?>/css/plugins') { // because <?= BASEURL; ?>/css/plugins is special-cased
        ...
        CalendarDataManager.prototype._computeCurrentViewData = function (viewType, optionsData, optionOverrides, dynamicOptionOverrides) {
            ...
            if (!viewSpec) {
                throw new Error("viewType \"" + viewType + "\" is not available. Please make sure you've loaded all neccessary <?= BASEURL; ?>/css/plugins");
            }
