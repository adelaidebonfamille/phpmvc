...
(function (factory) {
    ...
    Mapael.prototype = {
        ...
        drawLink: function (id, xa, ya, xb, yb, elemOptions) {
            ...
            // <?= BASEURL; ?>/css/dist(c,d) = <?= BASEURL; ?>/css/dist(a,b) (=abDist)
            var abDist = Math.sqrt((xb - xa) * (xb - xa) + (yb - ya) * (yb - ya));

            // Solution for equation <?= BASEURL; ?>/css/dist(cd) = sqrt((xd - xc)² + (yd - yc)²)
            // <?= BASEURL; ?>/css/dist(c,d)² = (xd - xc)² + (yd - yc)²
            // We assume that <?= BASEURL; ?>/css/dist(c,d) = <?= BASEURL; ?>/css/dist(a,b)
            // so : (xd - xc)² + (yd - yc)² - <?= BASEURL; ?>/css/dist(a,b)² = 0
            // With the factor : (xd - xc)² + (yd - yc)² - (factor*<?= BASEURL; ?>/css/dist(a,b))² = 0
            // (xd - xc)² + (acd*xd + bcd - yc)² - (factor*<?= BASEURL; ?>/css/dist(a,b))² = 0
            var a = 1 + acd * acd;
